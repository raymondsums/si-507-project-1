...
# A silly function, but it does kind of work to play a game. Because it's writt
# en in a silly way, there are a bunch of edge cases of sorts.
def play_war_game(testing=False):
    # Call this with testing = True and it won't print out all the game mechani
    # s, which makes it easier to see tests.
    player1 = Deck()
    player2 = Deck()
...
# 0:94: execution error: "https://itunes.apple.com/us/album/bears-adventure/id
# 495954957?i=495955054&uo=4" doesn’t understand the “open location” message.
# (-1708)
# That's an Apple-related error but will not cause you a problem. Don't worry
# about it.
